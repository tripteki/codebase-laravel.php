...
class PostBaseServiceProvider extends ServiceProvider
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public static $moduleName = "Post";

    /**
     * @var string
     */
    public static $moduleNameLower = "post";
    ...
    public function register()
    {
        ...
        $this->app->register(PostEventListenerServiceProvider::class);
    }

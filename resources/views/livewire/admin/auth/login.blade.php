...
@section('auth_right')
    <div
        class="w-full relative overflow-hidden flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-0 text-white auth-hero-bg min-h-screen lg:min-h-0">
        <div

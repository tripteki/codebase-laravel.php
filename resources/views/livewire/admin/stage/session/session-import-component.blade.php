                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <div class="flex-1">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                            {{ __('module_stage.import_sessions') }}
                        </h3>
                    ...
                    <form wire:submit.prevent="import">
                        <div class="mb-4">
                            <label for="import-file"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('module_base.select_file') }}</label>
                            <input type="file" id="import-file" wire:model="importFile" accept=".csv,.xls,.xlsx"
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                {{ __('module_base.import_file_hint') }}</p>
                        </div>
                        <div class="flex items-center justify-end gap-3">
                            ...
                            <button type="submit"
                                class="py-1.5 px-3 text-xs font-medium text-center text-white rounded-lg btn-secondary">{{ __('module_base.import') }}</button>
                        </div>
                    </form>
                </div>
            </div>

<div>
    ...
    <form wire:submit.prevent="save" class="space-y-8">
        <div class="p-4 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    @error('name')
                        <p class="mt-1 text-sm text-[hsl(0,84.2%,60.2%)] dark:text-[hsl(0,62.8%,30.6%)]">{{ $message }}
                        </p>
                    @enderror
                </div>
            ...
            <div class="space-y-6 flex flex-col items-center">
                    ...
                    <div class="flex flex-col items-center gap-4">
                        <div class="flex-shrink-0">
                            <div class="relative w-24 h-24">
                                ...
                                @elseif ($avatarUrl)
                                    <img src="{{ asset('storage/' . $avatarUrl) }}" alt="Avatar"
                        ...
                        <div class="w-full">
                            <input type="file" id="avatar" wire:model.live="avatar" accept="image/*"
                ...
                <div class="w-full max-w-md" x-data="{
                    ...
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-center">
                        {{ __('module_setting.interests') }}
                    </label>
                    <p class="mb-2 text-xs text-gray-500 dark:text-gray-400 text-center">
                        {{ __('module_setting.interests_hint') }}
                    </p>
                    ...
                    <div class="relative flex gap-2">
                        <div class="flex-1 relative">
                            <input type="text" wire:model.live="newInterest" wire:keydown.enter.prevent="addInterest"
                                @focus="open = true" @blur="setTimeout(() => open = false, 200)"
                                placeholder="{{ __('module_setting.interests_placeholder') }}"
                                class="input-primary shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                            <div x-show="open && filtered.length" x-transition
                                ...
                                <template x-for="item in filtered" :key="item">
                                    <button type="button" @click="$wire.addInterestValue(item); open = false"
                    ...
                    @error('interests')
                        <p class="mt-1 text-sm text-[hsl(0,84.2%,60.2%)] dark:text-[hsl(0,62.8%,30.6%)] text-center">
                            {{ $message }}</p>
                    @enderror
                    @error('interests.*')
                        <p class="mt-1 text-sm text-[hsl(0,84.2%,60.2%)] dark:text-[hsl(0,62.8%,30.6%)] text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" data-password-toggle="passwordConfirmation"
                            class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                            <svg id="passwordConfirmation-eye-icon" class="w-5 h-5" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <svg id="passwordConfirmation-eye-off-icon" class="w-5 h-5 hidden" fill="none"
                                stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M13.875 18.825A10.05 10.05 0 0 1 12 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 0 1 1.563-3.029m5.858.908a3 3 0 1 1 4.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0 1 12 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 0 1-4.132 5.411m0 0L21 21" />
                            </svg>
        ...
        <div class="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
            <button type="submit" class="px-3 py-1.5 text-xs font-medium text-white rounded-lg btn-primary">
                {{ __('module_base.save') }}
            </button>
        </div>
    </form>

<div
    x-data="{ show: false, roleId: null, roleName: '' }"
    x-show="show"
    x-cloak
...
>
    ...
    >
        ...
        <div class="p-4 md:p-5">
            <p class="mb-4 text-center text-sm text-gray-500 dark:text-gray-400" x-text="'{{ __("module_base.confirm_delete_message") }}'.replace(':name', roleName)"></p>
            <div class="flex items-center justify-end gap-3">
                ...
                <button
                    type="button"
                    wire:click="deleteRole({ roleId }); show = false"

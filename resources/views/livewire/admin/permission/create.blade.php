            ...
            <div class="mx-auto">
                <div class="mb-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                        {{ __("module_permission.add_new_permission") }}
                    </h1>
                </div>
                    ...
                    <form wire:submit.prevent="save" class="p-6 space-y-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __("module_permission.name") }}</label>
                                <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">{{ __("module_permission.name_description") }}</p>
                                <input
                                    id="name"
                                    type="text"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="guard_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __("module_permission.guard_name") }}</label>
                                <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">{{ __("module_permission.guard_name_description") }}</p>
                                <select
                                    id="guard_name"

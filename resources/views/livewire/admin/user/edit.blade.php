                    ...
                    @else
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label for="password"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('module_user.new_password_optional') }}</label>
                                    <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">
                                        {{ __('module_user.new_password_description') }}</p>
                                    <div class="relative">
                                ...
                                <div>
                                    ...
                                    <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">
                                        {{ __('module_user.confirm_new_password_description') }}</p>
                                    <div class="relative">

<div>
    ...
    <div class="min-h-screen flex flex-col bg-gray-100 lg:pl-64 dark:bg-gray-900" data-sidebar-content>
        ...
        <main id="main-content" class="flex-1 px-4 py-6 lg:px-6">
                        ...
                        <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="{{ route('admin.users.index') }}" class="ml-1 text-gray-700 hover:text-primary-600 md:ml-2 dark:text-gray-300 dark:hover:text-white">{{ __("module_user.title") }}</a>
                                </div>
                            </li>
                            <li>
                                <div class="flex items-center">
            ...
            <div class="mt-4">
                <livewire:admin.user.user-index-data-table-component />
            </div>
        </main>
    </div>
</div>

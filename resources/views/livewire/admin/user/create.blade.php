            ...
            <div class="mx-auto">
                ...
                <div class="bg-white rounded-lg shadow dark:bg-gray-800">
                    <form wire:submit.prevent="save" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __("module_user.password") }}</label>
                                <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">{{ __("module_user.password_description") }}</p>
                                <div class="relative">
                                    <input
                                        id="password"
                                        type="password"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="password_confirmation" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __("module_user.confirm_password") }}</label>
                                <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">{{ __("module_user.confirm_password_description") }}</p>
                                <div class="relative">
                                    <input

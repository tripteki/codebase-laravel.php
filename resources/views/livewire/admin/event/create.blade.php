        ...
        <div class="mx-auto">
            <div class="mb-4">
                ...
                <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">
                    {{ __('module_event.create_event') }}</h1>
            </div>
                    ...
                    @if (config('tenancy.type') !== 'path' && $step === 2)
                        <div>
                            ...
                            @foreach ($domains as $index => $domain)
                                <div class="flex gap-2 mb-2 items-center" wire:key="domain-{{ $index }}">
                                    <input type="text" wire:model.defer="domains.{{ $index }}"
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400">
                                                Default: <code>{{ $defaultFaviconIcoPath }}</code>
                                            </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400">
                                                Default: <code>{{ $defaultFaviconPngPath }}</code>
                                            </div>
                                    ...
                                    @php
                                        $logoPngSrc = $icon ? $icon->temporaryUrl() : asset($defaultLogoPngPath);
                                    @endphp
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        <div
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400">
                                                Default: <code>{{ $defaultLogoPngPath }}</code>
                                            </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400">
                                                Default: <code>{{ $defaultBrandLightPath }}</code>
                                            </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                                        ...
                                        <div class="flex-1 space-y-1">
                                            ...
                                            <div class="text-[11px] text-gray-500 dark:text-gray-400">
                                                Default: <code>{{ $defaultBrandDarkPath }}</code>
                                            </div>

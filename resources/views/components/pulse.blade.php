        ...
        <script>
            (function () {
                ...
                function applyAppTheme() {
                    ...
                    var def = (root.getAttribute("data-default-theme") || "light").toLowerCase();
                    var storedValue = (stored || "").toLowerCase();
                    var isDark = def === "dark" || storedValue === "dark";
    ...
    <body class="bg-gray-50 dark:bg-gray-950 font-sans antialiased">
        <div class="min-h-screen">
            ...
            <main class="pt-6 px-6 pb-12">
                <div {{ $attributes->merge(['class' => "mx-auto grid default:grid-cols-{$cols} default:gap-6 default:items-stretch" . ($fullWidth ? '' : ' container')]) }}>
                    {{ $slot }}
                </div>
            </main>
        </div>
